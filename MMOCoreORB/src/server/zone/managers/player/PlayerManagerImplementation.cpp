...
int PlayerManagerImplementation::awardExperience(CreatureObject* player, const String& xpType,
	...
	if (xpType == "force_rank_xp") {
		if (player->hasSkill("force_rank_light_novice") || player->hasSkill("force_rank_dark_novice")) {
			...
			FrsManager* frsManager = player->getZoneServer()->getFrsManager();
			...
			//TODO: This stuff really needs to happen in the sePlayerRank frs function not here
			if (curExp < 10000) {
				frsManager->setPlayerRank(player, 0);
				frsSkillCheck(player, "novice", "rank_01");
			}
			if (curExp >= 10000 && curExp < 20000) {
				frsManager->setPlayerRank(player, 1);
				frsSkillCheck(player, "rank_01", "rank_02");
			}
			if (curExp >= 20000 && curExp < 30000) {
				frsManager->setPlayerRank(player, 2);
				frsSkillCheck(player, "rank_02", "rank_03");
			}
			if (curExp >= 30000 && curExp < 65000) {
				frsManager->setPlayerRank(player, 3);
				frsSkillCheck(player, "rank_03", "rank_04");
			}
			if (curExp >= 65000 && curExp < 150000) {
				frsManager->setPlayerRank(player, 4);
				frsSkillCheck(player, "rank_04", "rank_05");
			}
			if (curExp >= 150000 && curExp < 225000) {
				frsManager->setPlayerRank(player, 5);
				frsSkillCheck(player, "rank_05", "rank_06");
			}
			if (curExp >= 225000 && curExp < 325000) {
				frsManager->setPlayerRank(player, 6);
				frsSkillCheck(player, "rank_06", "rank_07");
			}
			if (curExp >= 325000 && curExp < 450000) {
				frsManager->setPlayerRank(player, 7);
				frsSkillCheck(player, "rank_07", "rank_08");
			}
			if (curExp >= 450000 && curExp < 600000) {
				frsManager->setPlayerRank(player, 8);
				frsSkillCheck(player, "rank_08", "rank_09");
				SkillManager::instance()->awardSkill("force_title_jedi_rank_04", player, true, true, true);
			}
			if (curExp >= 600000 && curExp < 775000) {
				frsManager->setPlayerRank(player, 9);
				frsSkillCheck(player, "rank_09", "rank_10");
			}
			if (curExp >= 775000 && curExp < 1000000) {
				frsManager->setPlayerRank(player, 10);
				frsSkillCheck(player, "rank_10", "master");
			}
			if (curExp >= 1000000) {
				frsManager->setPlayerRank(player, 11);
