...
bool MissionManagerImplementation::isBountyValidForPlayer(CreatureObject* player, PlayerBounty* bounty) {
	...
	int maxNumberOfMissions = 4; //4 missions max at padawan->rank 4 FRS
	
	if (creature->hasSkill("force_rank_dark_rank_03") || creature->hasSkill("force_rank_light_rank_03")) //3 hunters at rank 4 FRS
		maxNumberOfMissions++;
